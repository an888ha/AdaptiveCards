//
//  CustomInputToggleRenderer.m
//  ADCIOSVisualizer
//
//  Created by Dunty Vinay Raj  on 27/08/18.
...
@implementation CustomInputToggleRenderer

+ (CustomInputToggleRenderer *) getInstance
{
    static CustomInputToggleRenderer *sharedInstance = nil;
        ...
        hostConfig:(ACOHostConfig *)acoConfig;
{
    ...
    ACRToggleInputDataSource *dataSource = [[ACRToggleInputDataSource alloc] initWithInputToggle:toggleBlck WithHostConfig:config withTintColor:[UIColor blueColor]];
